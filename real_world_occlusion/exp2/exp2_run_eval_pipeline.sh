#!/bin/bash
# ===== Configuration =====
OUT_PATH="/home/rsvargh2/Research/occlusion/real_world_occlusion/runs/exp2/run10"
DATA_PATH="/scratch/rsvargh2/occlusion_images/exp2"
LOG_FILE="errors_1_run10.log"
MODEL_NAMES=(
    # "Qwen2.5-VL"
    # "FT-Qwen2.5-VL"
    # "Gemma3"
...
for MODEL in "${MODEL_NAMES[@]}"; do
    ...
    run_cmd "$MODEL" "python exp2_calculate_alias_results.py --model_name \"$MODEL\" --out_path \"$OUT_PATH\""
done
# ===== Summary =====
echo ""
if [ -s "$LOG_FILE" ]; then
