...
class COCOFTQwen25VL:
    def __init__(self, model_save_dir="/scratch/rsvargh2/finetuned_huggingface_models/unsloth/coco/Qwen2.5-VL-7B-Instruct-sft-lora-3/checkpoints/checkpoint-1500"):
