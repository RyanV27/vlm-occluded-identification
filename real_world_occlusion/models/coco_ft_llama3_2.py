...
class COCOFTLlama3_2:
    def __init__(self, model_save_path="/scratch/rsvargh2/finetuned_huggingface_models/unsloth/coco/Llama-3.2-11B-Vision-Instruct-sft-lora/"):
