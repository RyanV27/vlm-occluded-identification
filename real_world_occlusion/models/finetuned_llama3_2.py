...
class FTLlama3_2:
    def __init__(self, model_save_dir="/scratch/rsvargh2/finetuned_huggingface_models/unsloth/real/Llama-3.2-11B-Vision-Instruct-sft-lora"):
...
if __name__ == "__main__":
    ...
    response, _, _ = model.run_inference(
        ...
        image_path="/content/drive/MyDrive/Thesis/exp2/images/no/1.jpg"
    )
    print(response)