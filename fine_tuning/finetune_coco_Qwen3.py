...
PRETRAINED_MODEL = "unsloth/Qwen3-VL-8B-Instruct-unsloth-bnb-4bit"
DATA_DIR = "/scratch/rsvargh2/coco/occluded_images/noise"
MODEL_SAVE_PATH = "/scratch/rsvargh2/finetuned_huggingface_models/unsloth/coco/Qwen3-VL-8B-Instruct-sft-lora-1/"


# Loading the model and LoRA modules ------------------------------------------- #
...
print(f"\nLength of finetuning data: {len(converted_dataset)}\n")
...
trainer_stats = trainer.train()            # Training code
